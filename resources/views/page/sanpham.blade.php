...
@section('content')
	<div class="inner-header">
		<div class="container">
			<div class="pull-left">
				<h6 class="inner-title">Thông tin của {{$sanpham->name}}</h6>
			</div>
			<div class="pull-right">
				<div class="beta-breadcrumb font-large">
					<a href="href={{route('trang-chu')}}">Home</a> / <span>Thông tin chi tiết</span>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-9">
					...
					<div class="beta-products-list">
							...
							<div class="col-sm-4">
								<div class="single-item">
									...
									<div class="single-item-header">
										<a href="{{route('san-pham', $sptt->id)}}"><img src="source/image/product/{{$sptt->image}}" alt="" height="250px"></a>
									</div>
									<div class="single-item-body">
									...
									<div class="single-item-caption">
										...
										<a class="beta-btn primary" href="{{route('san-pham', $sptt->id)}}">Details <i class="fa fa-chevron-right"></i></a>
										<div class="clearfix"></div>
									</div>
								</div>
							</div>
						...
						<div class="row">{{$same_prod->links()}}</div>						
