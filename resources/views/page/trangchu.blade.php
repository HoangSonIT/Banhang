								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="{{route('san-pham', $new->id)}}"><img src="source/image/product/{{$new->image}}" alt="" height="250px;"></a>
										</div>
										...
										<div class="single-item-caption">
											...
											<a class="beta-btn primary" href="{{route('san-pham', $new->id)}}">Details <i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										@endif										
										<div class="single-item-header">
											<a href="{{route('san-pham', $spkm->id)}}"><img src="source/image/product/{{$spkm->image}}" alt="" height="250px"></a>
										</div>
										<div class="single-item-body">
										...
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="{{route('themgiohang', $spkm->id)}}" style="margin-top: 5px;"><i class="fa fa-shopping-cart"></i></a>
											<a class="beta-btn primary" href="{{route('san-pham', $spkm->id)}}" style="margin-top: 5px; margin-bottom: 10px;">Details <i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								</div>
